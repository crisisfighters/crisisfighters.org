export const initiatives = [
  ...
  },
  {
    ...
    "description": {
      "content": "350.org's goal is to end the use of fossil fuels and transition to renewable energy by building a global, grassroots movement. Safety and justice for people across the globe is a critical part of 350.org's mission. By working with local community groups, 350.org aims to hold corporations and world leaders accountable to the realities of science and the principles of social justice. ",
      "updatedBy": "Alexander",
      "updatedAt": "2019-08-18"
    },
    "established": {
  ...
  },
  {
    ...
    "actions": {
      "content": "XR had it's most visible action so far when it caused [disruption in 5 UK cities in July 2019 (e.g. by blocking bridges in London)](https://rebellion.earth/2019/07/10/from-monday-15-july-extinction-rebellions-summer-uprising-act-now-to-cause-major-disruption-across-five-uk-cities/). Other, smaller acts of civil disobedience happen increasingly frequently world-wide.",
      "updatedBy": "Alexander",
      "updatedAt": "2019-08-18"
    },
    "pressArticles": {
  ...
  },
  {
    ...
    "description": {
      "content": "Friday for Future (FFF) started with the individual protest of [Greta Tunberg](https://en.wikipedia.org/wiki/Greta_Thunberg). In August 2018 thousands of pupils started to also skip school to protest for climate justice. Other groups like students or parents also joined the protests. FFF wants to push world leaders to provide a safe environment for future generations.",
      "updatedBy": "Andre",
  ...
  },
  {
    ...
    "description": {
      "content": "Ende Gelände is an organization with very flat hierarchies and was formed in 2015. They focus on stopping coal mining to mitigate the climate crisis. They have over 50 local branches in Germany and a few in other European countries. They organize an annual event of civil disobedience, which till now every year took place in the major coal mining area of central Germany. In 2017 and 2019 they organized two of such events. They block structures or machineries of this industry like train tracks diggers. Other actions include lectures and demonstrations. Since 2018 Ende Gelände engages on a European level, cooperating with organizations like [Hambacher Forst (DE)](https://hambacherforst.org/), [Limity Jsme My (CZ)](https://limityjsmemy.cz/en/) and Code Roode (NL).",
      "updatedBy": "Andre",
      "updatedAt": "2019-11-13"
    },
    "kpis": {
  ...
  },
  {
    ...
    "actions": {
      "content": "Handed out 1500+ grants that can be explored in their online [grants database](https://www.climateworks.org/portfolios/grants-database/). There's considerable focus on technical solutions. Grants are given out in these areas:\n- Buildings & Industry\n- Carbon Dioxide Removal\n- Clean Power\n- Cooling\n- Forests & Land Use\n- International Engagement\n- Mission Investing\n- Non-CO2 Mitigation\n- Sustainable Finance\n- Transportation",
      "updatedBy": "Alexander",
      "updatedAt": "2019-08-18"
    },
    "established": {
